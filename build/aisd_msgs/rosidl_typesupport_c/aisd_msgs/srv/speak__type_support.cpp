...
static const _Speak_Request_type_support_symbol_names_t _Speak_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aisd_msgs, srv, Speak_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aisd_msgs, srv, Speak_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aisd_msgs, srv, Speak_Request)() {
  return &::aisd_msgs::srv::rosidl_typesupport_c::Speak_Request_message_type_support_handle;
}
...
static const _Speak_Response_type_support_symbol_names_t _Speak_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aisd_msgs, srv, Speak_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aisd_msgs, srv, Speak_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aisd_msgs, srv, Speak_Response)() {
  return &::aisd_msgs::srv::rosidl_typesupport_c::Speak_Response_message_type_support_handle;
}
...
static const _Speak_type_support_symbol_names_t _Speak_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aisd_msgs, srv, Speak)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aisd_msgs, srv, Speak)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, aisd_msgs, srv, Speak)() {
  return &::aisd_msgs::srv::rosidl_typesupport_c::Speak_service_type_support_handle;
}
