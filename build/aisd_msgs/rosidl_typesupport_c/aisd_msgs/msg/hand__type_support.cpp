...
static const _Hand_type_support_symbol_names_t _Hand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aisd_msgs, msg, Hand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aisd_msgs, msg, Hand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aisd_msgs, msg, Hand)() {
  return &::aisd_msgs::msg::rosidl_typesupport_c::Hand_message_type_support_handle;
}
