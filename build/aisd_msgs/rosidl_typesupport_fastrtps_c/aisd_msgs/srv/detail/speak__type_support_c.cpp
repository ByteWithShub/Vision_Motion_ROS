...
#include "aisd_msgs/srv/detail/speak__rosidl_typesupport_fastrtps_c.h"
...
#include "aisd_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Speak_Request__ros_msg_type = aisd_msgs__srv__Speak_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aisd_msgs
size_t get_serialized_size_aisd_msgs__srv__Speak_Request(
  const void * untyped_ros_message,
...
static uint32_t _Speak_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aisd_msgs__srv__Speak_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aisd_msgs
size_t max_serialized_size_aisd_msgs__srv__Speak_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aisd_msgs__srv__Speak_Request;
    is_plain =
      (
...
static size_t _Speak_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aisd_msgs__srv__Speak_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aisd_msgs, srv, Speak_Request)() {
...
using _Speak_Response__ros_msg_type = aisd_msgs__srv__Speak_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aisd_msgs
size_t get_serialized_size_aisd_msgs__srv__Speak_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Speak_Response__ros_msg_type * ros_message = static_cast<const _Speak_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aisd_msgs__srv__Speak_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aisd_msgs
size_t max_serialized_size_aisd_msgs__srv__Speak_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aisd_msgs__srv__Speak_Response;
    is_plain =
      (
...
static size_t _Speak_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aisd_msgs__srv__Speak_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aisd_msgs, srv, Speak_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aisd_msgs, srv, Speak)() {
