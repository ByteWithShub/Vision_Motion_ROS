...
class Metaclass_Speak_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('aisd_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Speak(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from aisd_msgs.srv import _speak
...
class Speak(metaclass=Metaclass_Speak):
    from aisd_msgs.srv._speak import Speak_Request as Request
    from aisd_msgs.srv._speak import Speak_Response as Response
