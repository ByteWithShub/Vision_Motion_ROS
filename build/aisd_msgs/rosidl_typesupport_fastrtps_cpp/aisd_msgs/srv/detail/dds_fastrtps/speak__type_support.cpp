...
#include "aisd_msgs/srv/detail/speak__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aisd_msgs::srv::Speak_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aisd_msgs::srv::Speak_Request & ros_message)
{
  // Member: words
  cdr >> ros_message.words;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aisd_msgs::srv::Speak_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aisd_msgs::srv::Speak_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aisd_msgs::srv::Speak_Request *>(
    untyped_ros_message);
...
static size_t _Speak_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Speak_Request(full_bounded, is_plain, 0);
...
{
  return &aisd_msgs::srv::typesupport_fastrtps_cpp::_Speak_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aisd_msgs, srv, Speak_Request)() {
  return &aisd_msgs::srv::typesupport_fastrtps_cpp::_Speak_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_aisd_msgs
cdr_serialize(
  const aisd_msgs::srv::Speak_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: response
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aisd_msgs::srv::Speak_Response & ros_message)
{
  // Member: response
  cdr >> ros_message.response;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aisd_msgs::srv::Speak_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aisd_msgs::srv::Speak_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<aisd_msgs::srv::Speak_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _Speak_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Speak_Response(full_bounded, is_plain, 0);
...
{
  return &aisd_msgs::srv::typesupport_fastrtps_cpp::_Speak_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aisd_msgs, srv, Speak_Response)() {
  return &aisd_msgs::srv::typesupport_fastrtps_cpp::_Speak_Response__handle;
}
...
{
  return &aisd_msgs::srv::typesupport_fastrtps_cpp::_Speak__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aisd_msgs, srv, Speak)() {
  return &aisd_msgs::srv::typesupport_fastrtps_cpp::_Speak__handle;
}
