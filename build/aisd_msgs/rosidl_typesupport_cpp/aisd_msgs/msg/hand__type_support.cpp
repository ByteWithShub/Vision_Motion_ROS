...
static const _Hand_type_support_symbol_names_t _Hand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aisd_msgs, msg, Hand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aisd_msgs, msg, Hand)),
  }
};
...
{
  return &::aisd_msgs::msg::rosidl_typesupport_cpp::Hand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aisd_msgs, msg, Hand)() {
  return get_message_type_support_handle<aisd_msgs::msg::Hand>();
}
