...
static const _Speak_Request_type_support_symbol_names_t _Speak_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aisd_msgs, srv, Speak_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aisd_msgs, srv, Speak_Request)),
  }
};
...
{
  return &::aisd_msgs::srv::rosidl_typesupport_cpp::Speak_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aisd_msgs, srv, Speak_Request)() {
  return get_message_type_support_handle<aisd_msgs::srv::Speak_Request>();
}
...
static const _Speak_Response_type_support_symbol_names_t _Speak_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aisd_msgs, srv, Speak_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aisd_msgs, srv, Speak_Response)),
  }
};
...
{
  return &::aisd_msgs::srv::rosidl_typesupport_cpp::Speak_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aisd_msgs, srv, Speak_Response)() {
  return get_message_type_support_handle<aisd_msgs::srv::Speak_Response>();
}
...
static const _Speak_type_support_symbol_names_t _Speak_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aisd_msgs, srv, Speak)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aisd_msgs, srv, Speak)),
  }
};
...
{
  return &::aisd_msgs::srv::rosidl_typesupport_cpp::Speak_service_type_support_handle;
}
